        ...
        <div className="grid g:2" id="app">
            <div className="height h:96d sticky s:t0 s:tl width w:100p scroll:y either">
                <div className="width flex f:v gap:2 margin:1 padding:1">
                    <div className="flex ta:r" onClick={() => setClockType(clockType === "analog" ? "digital" : "analog")}>
                    ...
                    <div className="width flex f:v ta:r">
                        <div className="flex f:v gap:1 ta:r either">
                            <div className="flex gap:0 ta:r">
                                <a onClick={() => changeFontSize('decrease')} className="button font-button" title="Decrease font size">{fontSize - 1}</a>
                                <a onClick={() => changeFontSize('reset')} className="button font-button" title="Reset font size">reset</a>
                                <a onClick={() => changeFontSize('increase')} className="button font-button" title="Increase font size">{fontSize + 1}</a>
                            </div>
                    ...
                    <div className="container-item">
                        <div className="flex f:v ta:c gap:2">
                            ...
                            <div className="social flex gap:2 ta:c">
                                ...
                                <a href="https://www.linkedin.com/in/anubhavsaini-com/" target="_blank" rel="nofollow" title="LinkedIn">
